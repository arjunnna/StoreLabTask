...
class FavouriteImagesViewModel {
    ...
    var imagesList: [FavouriteImages] = []
    ...
    func getImageModel(_ indexPath: Int) -> ImageModel {
        let favouriteImage = self.imagesList[indexPath]
        return ImageModel(imageId: favouriteImage.imageId, author: favouriteImage.author, url: favouriteImage.url, downloadUrl: favouriteImage.downloadUrl)
    }
